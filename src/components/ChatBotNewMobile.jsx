...
const ChatBotNewMobile = () => {
  ...
  // Legacy subdomain handler - kept for backward compatibility but not used in new flow
  ...
  return (
    <div className="chatbot-container">
      ...
      <div className="chat-window">
        ...
        {['goal', 'domain', 'task', 'rca-stage1'].includes(flowStage) ? (
      ...
      {/* Input Area */}
      {!['goal', 'domain'].includes(flowStage) && (
